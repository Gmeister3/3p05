...
Both $N(2)$ and $N(0)$ are base cases.
Number of nodes: $T(3) = 3$ (one root, two children)
...
$N(3) = N(2) + N(0)$ (both base cases), $N(1)$ is a base case.
Number of nodes: $T(4) = 5$
...
$N(4) = N(3) + N(1)$, where $N(3) = N(2) + N(0)$. $N(2)$ is a base case.
Number of nodes: $T(5) = 7$
...
$N(5)$ subtree contributes 7 nodes, $N(3)$ subtree contributes 3 nodes.
Including the root: Number of nodes: $T(6) = 11$
...
$L(2) = L(1) + L(0)$ (both base cases), $L(1)$ is a base case.
Number of nodes: $T(3) = 5$
...
$L(3)$ expands to 5 nodes, $L(2)$ expands to 3 nodes.
With root: Number of nodes: $T(4) = 9$
...
$L(4)$ expands to 9 nodes, $L(3)$ expands to 5 nodes.
With root: Number of nodes: $T(5) = 15$
...
$L(5)$ expands to 15 nodes, $L(4)$ expands to 9 nodes.
With root: Number of nodes: $T(6) = 25$
